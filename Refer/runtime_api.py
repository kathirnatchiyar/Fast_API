...
import os
import subprocess
from Validation.token import  tokenValidation
...
def first_submit():
    auth_stat = tokenValidation("Python_Microservice", flask.request.get_json(), flask.request.headers )
    if(len(auth_stat) > 0):
        resp =  {
                        "status": "Failed",
                        "message": auth_stat
    ...
    inputTypes = {"ownerId": "Integer", "customerName": "String", "customerType": "String", "sessionUser": "String", "lob": "String", "transdb": "String", "uiux": "String", "wf": "String", "rating": "String","reportingdb": "String", }
    ...
    successmsg = "Successfully Initialized for the customer {} with owner id {} ".format(data["customerName"], data["ownerId"] )
    resp =  {
                    "status": "Initializing",
                    "message": successmsg
                }
